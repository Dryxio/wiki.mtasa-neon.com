...
export const neonFunctions: NeonFunction[] = [
  ...
  },
  {
    ...
    notes: ["The logical lease may be acquired before stream-in or sync ownership and survives native recreation and syncer generations.", "It becomes active only while this client is the authoritative ped syncer with a live native instance. Another resource cannot lease the same ped on this client.", "The mission profile currently restores stock EVENT_VEHICLE_ON_FIRE admission and mission decision selection. It does not serialize the active response task across migration or load custom SCM decision-maker files."],
