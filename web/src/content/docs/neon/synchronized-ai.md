...
- Vehicle transitions, arbitrary look/aim state, every physical response, and every GTA task family are not covered by one universal observer format.
